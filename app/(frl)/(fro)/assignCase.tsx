...
export default function AssignCaseScreen() {
      ...
      <View>
        ...
        <View style={styles.froCard}>
          <View style={styles.froTopRow}>
            ...
            >
              <Text style={[{ fontWeight: "700", fontSize: 12 },{color:theme.colors.colorPrimary600}]}>
          ...
          <View style={styles.froRowInfo}>
            <View style={styles.iconRow}>
              ...
              <Text style={styles.froInfoText}>
                {RECOMMENDED_FRO.location}
              </Text>
            </View>
          ...
          <View style={styles.froStatRow}>
            <View style={[styles.froStatBox, { backgroundColor: "#ECFDF5" }]}>
              <Text style={[styles.statLabel,{color:theme.colors.colorPrimary600}]}>Cases Today</Text>
              <Text style={[styles.statValue,{color:theme.colors.colorPrimary600}]}>
                {RECOMMENDED_FRO.casesToday}
              </Text>
            </View>

            <View style={[styles.froStatBox, { backgroundColor: "#FFF7ED" }]}>
              <Text style={[styles.statLabel,{color:theme.colors.colorPrimary600}]}>Solved</Text>
              <Text style={[styles.statValue,{color:theme.colors.colorPrimary600}]}>{RECOMMENDED_FRO.solved}</Text>
            </View>

            <View style={[styles.froStatBox, { backgroundColor: "#EFF6FF" }]}>
            <Text style={[styles.statLabel,{color:theme.colors.colorPrimary600}]}>Rating</Text>
              <Text style={[styles.statValue,{color:theme.colors.colorPrimary600}]}>{RECOMMENDED_FRO.rating}</Text>
            </View>
          </View>
        </View>
