  ...
  return (
    <>
      ...
      <View style={styles.card}>
        ...
        <CategoryRow label="Medical Emergency" value="45 Cases" percent={70} color="#1e88e5" />
        <CategoryRow label="Legal Aid" value="28 Cases" percent={45} color="#fb8c00" />
        <CategoryRow label="Pension Support" value="32 Cases" percent={55} color="#2e7d32" />
        <CategoryRow label="Food Security" value="15 Cases" percent={30} color="#c62828" />
        <CategoryRow label="Housing" value="08 Cases" percent={25} color="#ef6c00" />
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.statusGrid}>
          ...
          <StatusBox value="15" label="In Progress" bg="#e8f5e9" color="#2e7d32" />
          <StatusBox value="05" label="Resolved" bg="#e3f2fd" color="#1e88e5" />
          <StatusBox value="02" label="Follow-up" bg="#fdecea" color="#c62828" />
