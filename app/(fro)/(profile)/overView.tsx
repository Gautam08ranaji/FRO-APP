    ...
    <>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.statsGrid}>
          ...
          <StatBox title="Active Cases" value="42" bg="#e3f2fd" color="#1976d2" />
          <StatBox
...
const PerformerCard = ({ rank, name, id, cases, rating }: any) => (
  <View style={styles.performerRow}>
    ...
    <View style={{ alignItems: "flex-end" }}>
      <Text style={styles.caseCount}>{cases} Cases</Text>
