...
export default function ArticleScreen() {
  ...
  return (
    <BodyLayout type="screen" screenName="Article">
      {/* ---------- TITLE + TAG ---------- */}
      ...
      {/* Divider */}
      <View
        style={[styles.divider, { backgroundColor: theme.colors.colorBorder }]}
      />
      ...
      <Text
        style={[styles.bulletPoint, { color: theme.colors.colorTextSecondary }]}
      >
        • {t("article.point1")}
      </Text>
      ...
      <Text
        style={[styles.paragraph, { color: theme.colors.colorTextSecondary }]}
      >
