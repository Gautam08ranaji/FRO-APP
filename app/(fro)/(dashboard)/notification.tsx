...
export default function NotificationScreen() {
  ...
  const fetchInteractions = async () => {
    try {
      ...
      console.log("Fetched interat notifications:", res?.data?.interactions);
          ...
          >
            <View style={styles.topRow}>
              ...
              <View style={styles.titleContainer}>
                ...
                <View style={styles.contactRow}>
                  <RemixIcon name="user-line" size={14} color="#666" />
                  <Text
                    style={[
                      styles.contactName,
                      { color: theme.colors.colorTextSecondary },
            ...
            {item.mobileNo && (
              <View style={[styles.infoRow, styles.indented]}>
                <RemixIcon name="phone-line" size={14} color="#666" />
                <Text
                  style={[
                    styles.infoText,
                    { color: theme.colors.colorTextSecondary },
            ...
            {item.location && (
              <View style={[styles.infoRow, styles.indented]}>
                <RemixIcon name="map-pin-line" size={14} color="#666" />
                <Text
                  style={[
                    styles.infoText,
                    { color: theme.colors.colorTextSecondary },
